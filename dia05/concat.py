...
#Concatena os dataframes, juntado PELOS ÍNDICESS
#drop = True joga fora a coluna de index antigo
...
#Ordena pela renda decrescente e pelo sobrenome crescente
df_03
# %%

pd.concat([df_01, df_03], axis=1)
# axis=1  concatena como coluna (do lado)
#axis = 0 concatena como linha (embaixo)